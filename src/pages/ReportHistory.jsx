...
const ReportHistory = () => {
  ...
  const requestPermanentDeleteSelected = (targetIds = trashSelectedIds) => {
    ...
    setConfirmModal({
      ...
      message: `HAPUS PERMANEN ${targetIds.length} laporan terpilih? Tindakan ini tidak dapat dibatalkan dan data akan terhapus selamanya dari LaporGo!`,
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        {loading ? (
          <div className="flex items-center justify-center gap-3 py-16 text-slate-400">
            ...
            <span className="text-sm">Memuat data LaporGo...</span>
          </div>
        ) : (
